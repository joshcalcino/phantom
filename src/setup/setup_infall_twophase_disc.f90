...
!   - add_warm   : *add atomic warm neutral background gas by default*
...
subroutine set_default_options()
 ...
 !--two-phase atomic warm neutral background
...
subroutine write_setupfile(filename)
 ...
 call write_inopt(add_warm,'add_warm','add atomic warm neutral background gas by default?',iunit)
